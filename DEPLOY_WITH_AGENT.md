...
Read README.md, docs/WALKTHROUGH.md, and docs/SETUP_NOTES.md first. Work in this repository and use its pinned CLI tools. Read the bundled official skill at `.agents/skills/stripe-projects/SKILL.md`; after initialization, follow the CLI reference skill generated by Projects.
